...
- [ ] **Step 2: sql.js の WASM を public/assets に配置**
...
- [ ] **Step 5: QuickScannerButton の遷移先を変更**
...
- [ ] **Step 5: ScannerPage から workSessionStore を除去**
